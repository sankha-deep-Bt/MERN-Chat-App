...
const Login = () => {
  return (
    ...
    <div className='w-full p-6 rounded-lg shadow-md bg-blue-500'>
        <h1 className='text-3xl text-center font-semibold text-gray-300'>Login <span className='text-sky-200'>BtChat</span></h1>
        <form >
            <div>
            ...
            <button className='btn btn-sm btn-block mt-2 bg-sky-500 hover:bg-blue-600 text-white border-none'>Login</button>
        </form>
        </div>
    </div>
  )
